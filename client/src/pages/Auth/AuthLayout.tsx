    ...
    <div className=' md:bg-[#EAEAEA] z-10 overflow-y-hidden relative'>
      ...
      <div className=' hidden md:block w-full bottom-0 absolute z-20'>
        <div className=' h-1/2 xl:translate-y-20'>
          <div className='w-full flex justify-center items-center '>
             <img src={"https://img.freepik.com/free-vector/futuristic-background-design_23-2148503793.jpg?size=626&ext=jpg&ga=GA1.1.44546679.1716940800&semt=ais_user"} alt='LoginBG ' className=' w-full' />
          </div>
        </div>
      </div>
